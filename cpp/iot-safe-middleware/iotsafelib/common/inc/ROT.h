...
#define CONTAINER_ID_PORT_AND_URL           8
...
class ROT: public Applet {
	 ...
	 * @param[in]  u16MaxLen Maximum length allowed to return the certificate
	 ...
	 */
	int getCertificateByContainerId(const uint8_t *containerId, uint16_t containerIdLen, uint16_t u16MaxLen, uint8_t *cert, uint16_t *certLen);
